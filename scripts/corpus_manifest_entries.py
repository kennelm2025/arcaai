...
def main() -> int:
    ...
    for f in sorted(DOCS.iterdir()):
        ...
        print("    sa5_classification: internal-sensitive")
        print(f"    content_sha256: \"{sha}\"")
        print("    eligibility:")
        print("      - state: pending_review")
        print("        date: <today>")
        print("        reason: \"authored; awaiting review\"")
        print("    processing:")
        print("      chunker_version: null")
        print("      embedding_model: null")
        print("      chunk_count: null")
        print("      ingest_timestamp: null")
        print()
