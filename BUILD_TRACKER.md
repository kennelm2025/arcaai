...
|-------|----|-------|--------|-------|------|------|
| B1 | 1 | Foundation — repo, CI, Postgres, MLflow, DVC | NOT STARTED | NOT STARTED | NOT STARTED | |
| B2 | 1–2 | Synthetic data — fraud (generator, GE suite, data dictionary) | NOT STARTED | NOT STARTED | NOT STARTED | |
| B3 | 2–3 | Fraud features + anti-leakage suite | NOT STARTED | NOT STARTED | NOT STARTED | |
| B4 | 3 | Baseline + MVM + calibration (fraud) | NOT STARTED | NOT STARTED | NOT STARTED | |
