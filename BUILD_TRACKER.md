...
| B6 | 4–5 | LangGraph agent v0 + LLM (Llama 3.1 8B) | IN PROGRESS - inc1 (LLM smoke, TI7 pin) + inc2 (hello-graph) + inc3 (score node, HTTP to B5 service) | IN PROGRESS | NOT STARTED | |
